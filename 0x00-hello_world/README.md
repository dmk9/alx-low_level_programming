...
- [Struggling with the sandbox? Try this: Using Docker & WSL on your local host](<[text](https://intranet.alxswe.com/concepts/100039)>)
- [C programming](https://intranet.alxswe.com/concepts/26)

# Resources

**Read or watch:**
[![Hello World](http://img.youtube.com/vi/co0b0xLEuRM/0.jpg)](http://www.youtube.com/watch?v=co0b0xLEuRM "Hello World - Introduction to C programming")
